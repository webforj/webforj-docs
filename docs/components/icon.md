...
Icons can be generated by using the names listed on the websites.
...
1. `REUGLAR`: The outlined variate of icons. This is the default.
...
## Styling
Unless established, the icon will inherit the theme of its direct parent component.
