...
image: '../../static/release_blog/_images/24.11.png'
...
To utilize these slots, getter and setter methods for prefix and suffix slots have been added. Below are examples for a [`Button`](../../docs/components/button), as well as for a [`DateField`](../../docs/components/fields/date-field):
...
<ComponentDemo 
path='https://demo.webforj.com/webapp/controlsamples/IconDemo?' 
